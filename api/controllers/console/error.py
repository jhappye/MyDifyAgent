...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "垣码平台 has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "垣码平台 has not been initialized and installed yet. "
